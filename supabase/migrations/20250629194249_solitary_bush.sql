-- Enhanced inline branching system with proper choice handling
-- This migration fixes the choice selection to work with difficulty-based selection

-- Update the select_question_choice function to handle difficulty-based selection
...
-- Enhanced verify_answer function to handle choice questions with media
...
BEGIN
  ...
  IF v_is_correct THEN
    ...
    ELSE
      ...
      -- Clean up any temporary choice questions for this team
      DELETE FROM questions 
      WHERE title LIKE 'Choice:%' 
        AND is_choice_question = true 
...
-- Clean up any existing temporary choice questions
DELETE FROM questions WHERE title LIKE 'Choice:%' AND is_choice_question = true;

-- Update existing sample data to use proper inline branching with media support
UPDATE questions 
SET 
